				...
				<div class="p-rooms__panel p-rooms__panel--active js-fadeUp" data-panel="small">
					...
					<div class="p-rooms__item js-fadeUp">
						...
						<div class="p-rooms__detail">
							...
							<div class="p-rooms__buttons">
								<a href="#" class="p-rooms__button p-rooms__button--layout js-layout-btn p-rooms__button-blue" data-layout-image="<?php echo get_template_directory_uri() ?>/images/common/room_ayame.webp">
									<p class="p-rooms__button-text">レイアウトを見る</p>
									<span class="p-rooms__button-icon">
										<img src="<?php echo get_template_directory_uri() ?>/images/common/icon_arrow.svg" alt="" width="20" height="20">
									</span>
					...
					<div class="p-rooms__item js-fadeUp">
						...
						<div class="p-rooms__detail">
							...
							<p class="p-rooms__description">最大50名収容可能な会場です。<br />地域団体、経済団体の定例会などにご使用いただけます。</p>
							<dl class="p-rooms__info">
								<div class="p-rooms__info-row">
									<dt class="p-rooms__info-label">間取</dt>
							...
							<div class="p-rooms__buttons">
								<a href="#" class="p-rooms__button p-rooms__button--layout js-layout-btn p-rooms__button-blue" data-layout-image="<?php echo get_template_directory_uri() ?>/images/common/room_takase.webp">
									<p class="p-rooms__button-text">レイアウトを見る</p>
									<span class="p-rooms__button-icon">
										<img src="<?php echo get_template_directory_uri() ?>/images/common/icon_arrow.svg" alt="" width="20" height="20">
									</span>
					...
					<div class="p-rooms__item js-fadeUp">
						...
						<div class="p-rooms__detail">
							...
							<p class="p-rooms__description">最大50名収容可能な会場です。<br />教育研修・勉強会、合宿のミーティングなどで使用可能です。</p>
							<dl class="p-rooms__info">
								<div class="p-rooms__info-row">
									<dt class="p-rooms__info-label">間取</dt>
							...
							<div class="p-rooms__buttons">
								<a href="#" class="p-rooms__button p-rooms__button--layout js-layout-btn p-rooms__button-blue" data-layout-image="<?php echo get_template_directory_uri() ?>/images/common/room_nagi.webp">
									<p class="p-rooms__button-text">レイアウトを見る</p>
									<span class="p-rooms__button-icon">
										<img src="<?php echo get_template_directory_uri() ?>/images/common/icon_arrow.svg" alt="" width="20" height="20">
									</span>
					...
					<div class="p-rooms__item js-fadeUp">
						...
						<div class="p-rooms__detail">
							...
							<div class="p-rooms__buttons">
								<a href="#" class="p-rooms__button p-rooms__button--layout js-layout-btn p-rooms__button-blue" data-layout-image="<?php echo get_template_directory_uri() ?>/images/common/room_yayoi.webp">
									<p class="p-rooms__button-text">レイアウトを見る</p>
									<span class="p-rooms__button-icon">
										<img src="<?php echo get_template_directory_uri() ?>/images/common/icon_arrow.svg" alt="" width="20" height="20">
									</span>
			...
			<div class="p-lunch__content">
				...
				<div class="p-menu__double mt60 js-fadeUp">
					<div class="p-menu__double-item">
						...
						<div class="p-menu__text-wrapper p-menu__text-wrapper--right">
							<p class="p-menu__text-right font-white">奈義和牛(100ｇ) / 季節野菜 / 森の卵 / 干し肉　煮凝り　巻柿 / 本日の御造り二種 / 御飯 / 漬物 / 津山銘菓「桐襲」とフルーツ</p>
						</div>
					</div>
					<div class="p-menu__double-item">
						<figure class="p-menu__double-img">
							<img src="<?php echo get_template_directory_uri() ?>/images/common/lunch_menu_2.jpg" alt="洋食ランチ" width="360" height="240">
						</figure>
						<div class="p-menu__double-detail">
						...
						<div class="p-menu__text-wrapper p-menu__text-wrapper--right">
							<p class="p-menu__text-right font-white">奈義和牛のそずり鍋 / 干し肉　煮凝り　巻柿 / 本日の御造り二種 / 海老（１尾）と穴子（1/4）と野菜の天ぷら / 御飯 / 漬物 / 津山銘菓「桐襲」とフルーツ</p>
						</div>
					</div>
				</div>
				<div class="p-menu__triple js-fadeUp">
					<div class="p-menu__double-item">
						...
						<div class="p-menu__text-wrapper p-menu__text-wrapper--right">
							<p class="p-menu__text-right font-white">奈義和牛ステーキ（120ｇ） / 温野菜 / 岡山名物海老飯 / 本日のスープ / 津山銘菓「桐襲」とフルーツ</p>
						</div>
					</div>
					<div class="p-menu__double-item">
						<figure class="p-menu__double-img">
							<img src="<?php echo get_template_directory_uri() ?>/images/common/lunch_menu_4.jpg" alt="和食ランチ" width="360" height="240">
						</figure>
						<div class="p-menu__double-detail">
						...
						<div class="p-menu__text-wrapper p-menu__text-wrapper--right">
							<p class="p-menu__text-right font-white">ばら寿司（ままかり・蛸・海老・蝦蛄・穴子） / 海老（１尾）と穴子（1/4）と野菜の天ぷら / 茶碗蒸し / 吸い物 / 津山銘菓「桐襲」とフルーツ</p>
						</div>
					</div>
					<div class="p-menu__double-item">
						<figure class="p-menu__double-img">
							<img src="<?php echo get_template_directory_uri() ?>/images/common/lunch_menu_5.jpg" alt="津山鶴山弁当" width="360" height="240">
						</figure>
						<div class="p-menu__double-detail">
						...
						<div class="p-menu__text-wrapper p-menu__text-wrapper--right">
							<p class="p-menu__text-right font-white">奈義和牛ステーキ（50ｇ） / 温野菜 / 海老（１尾）と穴子（1/4）と野菜の天ぷら / ゆかり御飯 / 本日の御造り二種 / 吸い物 / 和え物 / 漬物 / 津山銘菓「桐襲」</p>
						</div>
					</div>
