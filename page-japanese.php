        ...
        <div class="p-stay-mv__content">
          <div class="p-stay-mv__detail">
            <h2 class="c-main-title">
              ...
              <span class="c-main-title__ja">和室</span>
              <span class="c-main-title__en">Japanese Room</span>
            </h2>
          </div>
        </div>
      </div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <figure class="p-suite-swiper__img">
              <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/stay/jpn/img01.webp" alt="和室" width="1300" height="970">
            </figure>
          </div>
          <div class="swiper-slide">
            <figure class="p-suite-swiper__img">
              <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/stay/jpn/img02.webp" alt="和室" width="1300" height="970">
            </figure>
          </div>
          <div class="swiper-slide">
            <figure class="p-suite-swiper__img">
              <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/stay/jpn/img03.webp" alt="和室" width="1300" height="970">
            </figure>
          </div>
      ...
      <div class="l-inner">
        <div class="p-location__content">
          ...
          <div class="p-location__text-wrapper js-fadeUp">
            <p class="p-location__text">広々とした空間に、畳の温もりが感じられるお部屋です。<br>ゆったりと足を伸ばせる畳の上で、旅の疲れを癒やし、心安らぐひとときをお過ごしいただけます。</p>
          </div>
          ...
          <div class="p-rooms__qa mt66 js-fadeUp">
            <div class="p-service__left">
              ...
              <figure class="p-service__img mt50">
                <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/stay/room-jpn.webp" alt="宿泊サービス" width="400" height="600">
              </figure>
            </div>
