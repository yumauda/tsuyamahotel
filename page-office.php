		...
		<div class="p-page-mv__inner">
			<div class="p-page-mv__content">
				<figure class="p-page-mv__img">
					<img src="<?php echo get_template_directory_uri() ?>/images/common/mv_office.jpg" alt="サテライトオフィス" width="1860" height="670">
				</figure>
				<div class="p-page-mv__detail">
					<h2 class="p-page-mv__title">
						<span class="p-page-mv__title-ja">サテライトオフィス</span>
						<span class="p-page-mv__title-en">Satellite office</span>
					</h2>
				</div>
			</div>
		</div>
				...
				<div class="p-rooms__panel p-rooms__panel--active">
					<div class="p-rooms__item">
						...
						<div class="p-rooms__detail">
							<h3 class="p-rooms__name">601号室</h3>
							<p class="p-rooms__description">二人がゆったりと使えるデスクに、高機能チェアと高速Wi-Fiを完備。快適な環境でリモートワークやオンライン会議に集中できます。</p>
							<dl class="p-rooms__info mt40">
								<div class="p-rooms__info-row bt">
									<dt class="p-rooms__info-label">利用可能人数</dt>
									<dd class="p-rooms__info-value">2名まで</dd>
								</div>
								<div class="p-rooms__info-row">
									<dt class="p-rooms__info-label">利用可能日数</dt>
									<dd class="p-rooms__info-value">1時間～7日（要予約：1日前）</dd>
								</div>
								<div class="p-rooms__info-row">
									<dt class="p-rooms__info-label">事前予約</dt>
									<dd class="p-rooms__info-value">2ヵ月先の予約まで受付可能</dd>
								</div>
							</dl>
					...
					<div class="p-rooms__item">
						...
						<div class="p-rooms__detail">
							<h3 class="p-rooms__name">608号室</h3>
							<p class="p-rooms__description">高機能チェアと大型デスクを備え、最大6名での打ち合わせや共同作業に最適。明るく開放的な空間で、快適に仕事に取り組めます。</p>
							<dl class="p-rooms__info mt40">
								<div class="p-rooms__info-row bt">
									<dt class="p-rooms__info-label">利用可能人数</dt>
									<dd class="p-rooms__info-value">4名まで</dd>
								</div>
								<div class="p-rooms__info-row">
									<dt class="p-rooms__info-label">利用可能日数</dt>
									<dd class="p-rooms__info-value">1時間～7日（要予約：1日前）</dd>
								...
								<div class="p-rooms__info-row">
									<dt class="p-rooms__info-label">事前予約</dt>
									<dd class="p-rooms__info-value">1ヵ月先の予約まで受付可能</dd>
								</div>
							</dl>
							<div class="p-rooms__buttons">
								<a href="#" class="p-rooms__button p-rooms__button-blue">
					...
					<div class="p-rooms__item">
						...
						<div class="p-rooms__detail">
							<h3 class="p-rooms__name">609号室</h3>
							<p class="p-rooms__description">モダンなデザインの広々とした最大6名利用可能な共同ワークスペースです。プリンターを完備し、企画書作成などのお仕事にも取り組めます。</p>
							<dl class="p-rooms__info mt40">
								<div class="p-rooms__info-row bt">
									<dt class="p-rooms__info-label">利用可能人数</dt>
									<dd class="p-rooms__info-value">4名まで</dd>
								...
								<div class="p-rooms__info-row">
									<dt class="p-rooms__info-label">利用可能日数</dt>
									<dd class="p-rooms__info-value">1時間～12ヶ月（要予約：1日前）</dd>
								</div>
								<div class="p-rooms__info-row">
									<dt class="p-rooms__info-label">事前予約</dt>
									<dd class="p-rooms__info-value">1ヵ月先の予約まで受付可能<br>
										連続10日以上ご利用の方は3ヵ月先までご予約可能です。お電話にてお問い合わせ下さい。</dd>
								</div>
							</dl>
							<div class="p-rooms__buttons">
								<a href="#" class="p-rooms__button p-rooms__button-blue">
					...
					<div class="p-rooms__item">
						...
						<div class="p-rooms__detail">
							<h3 class="p-rooms__name">610号室</h3>
							<p class="p-rooms__description">広々した空間の開放感ある会議室です。集中力を高める環境でチーム作業やブレストを行えます。冷蔵庫も完備し、快適にお過ごしいただけます。</p>
							<dl class="p-rooms__info mt40">
								<div class="p-rooms__info-row bt">
									<dt class="p-rooms__info-label">利用可能人数</dt>
									<dd class="p-rooms__info-value">4名まで</dd>
					...
					<div class="p-all">
						<table class="p-all__table">
							<thead>
								<tr>
									<th class="p-all__header p-all__header--empty"></th>
									<th class="p-all__header p-all__cell--fee--black">
							...
							<tbody>
								<tr>
									<td class="p-all__label p-all__label--first p-all__label--fee">1時間</td>
									<td class="p-all__cell p-all__cell--fee--black">
										<p>1,100円</p>
									</td>
									<td class="p-all__cell p-all__cell--fee--black">
										<p>2,200円</p>
								...
								<tr>
									<td class="p-all__label p-all__label--fee">4時間</td>
									<td class="p-all__cell p-all__cell--fee--black">
										<p>3,300円</p>
									</td>
									<td class="p-all__cell p-all__cell--fee--black">
								...
								<tr>
									<td class="p-all__label p-all__label--fee">1日</td>
									<td class="p-all__cell p-all__cell--fee--black">
										<p>4,950円</p>
									</td>
									<td class="p-all__cell p-all__cell--fee--black">
								...
								<tr>
									<td class="p-all__label p-all__label--fee">1週間</td>
									<td class="p-all__cell p-all__cell--fee--black">
										<p>29,700円</p>
									</td>
									<td class="p-all__cell p-all__cell--fee--black">
								...
								<tr>
									<td class="p-all__label p-all__label--fee">1ヶ月</td>
									<td class="p-all__cell p-all__cell--fee--black">
										<p>-</p>
									</td>
									<td class="p-all__cell p-all__cell--fee--black">
								...
								<tr>
									<td class="p-all__label p-all__label--last p-all__label--fee">30日～</td>
									<td class="p-all__cell  p-all__cell--fee--black bb0">
										<p>-</p>
									</td>
									<td class="p-all__cell  p-all__cell--fee--black bb0">
										<p>-</p>
