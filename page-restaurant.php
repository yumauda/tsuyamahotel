		...
		<div class="p-page-mv__inner">
			<div class="p-page-mv__content">
				<figure class="p-page-mv__img">
					<img src="<?php echo get_template_directory_uri() ?>/images/common/mv_restaurant.jpg" alt="レストラン「NAGOMI」" width="1860" height="670">
				</figure>
				<div class="p-page-mv__detail">
					<h2 class="p-page-mv__title">
						<span class="p-page-mv__title-ja">レストラン「NAGOMI」</span>
			...
			<div class="p-facilities__content" id="anc01">
				...
				<div class="p-facilities__list p-facilities__list--taste">
					...
					<div class="p-facilities__item">
						...
						<div class="p-facilities__detail">
							<h4 class="p-facilities__item-title">奈義和牛（なぎビーフ）</h4>
							<p class="p-facilities__item-text">岡山県奈義町の1000ｍ級の山々に囲まれた澄んだ空気と清らかな自然環境の中で、丹念に育てられた「奈義和牛（なぎビーフ）」。指定農場で生産された肉牛で指定配合飼料と作州黒大豆を与えた肉牛に格付けされたものだけがその名前をつけられます。一口ごとに広がる豊潤な香りとコク深い余韻は、特別な一日の食卓をより華やかに彩ります。</p>
						</div>
					</div>
					...
					<div class="p-menu">
							...
							<div class="p-menu__detail">
								<div class="p-menu__detail-top">
									<div class="p-menu__title-flex">
										<h4 class="p-menu__title">和牛サーロインのロースト</h4>
						...
						<div class="p-menu__double">
							<div class="p-menu__double-item">
								...
								<div class="p-menu__double-detail">
									<h4 class="p-menu__double-title fz30">津山城下町御膳</h4>
									<p class="p-menu__double-tag">要予約</p>
								</div>
								<div class="p-menu__price-wrapper p-menu__price-wrapper--right">
									<p class="p-menu__price">4,180<span>円</span></p>
									<p class="p-menu__tax">（税込み）</p>
								</div>
								<div class="p-menu__text-wrapper p-menu__text-wrapper--right">
									<p class="p-menu__text-small">津山の郷土料理。県内外からお越しのお客様に「食」でおもてなし。「奈義和牛（なぎビーフ）」を贅沢に使用した そずり鍋・干し肉・煮こごりを是非、御賞味下さい。</p>
									...
									<p class="p-menu__text-right">奈義和牛（なぎビーフ）のそずり鍋 / 干し肉 / 煮凝り / 巻柿 / 御造り / 茶碗蒸し / 小鉢 / 御飯 / 漬物 / 吸い物 / フルーツ<br>
										※食材の仕入れ状況により一部内容が変わる場合がございます。※2日前までにご予約下さい。</p>
								</div>
							</div>
							<div class="p-menu__double-item">
								<figure class="p-menu__double-img">
									<img src="<?php echo get_template_directory_uri() ?>/images/common/menu_img3.webp" alt="なごみ御膳" width="360" height="240">
								</figure>
								<div class="p-menu__double-detail">
									<h4 class="p-menu__double-title fz30">なごみ御膳</h4>
									<p class="p-menu__double-tag">要予約</p>
								</div>
								<div class="p-menu__price-wrapper p-menu__price-wrapper--right">
									<p class="p-menu__price">3,630<span>円</span></p>
									<p class="p-menu__tax">（税込み）</p>
								</div>
								<div class="p-menu__text-wrapper p-menu__text-wrapper--right">
									<p class="p-menu__text-small">テキストが入ります。ダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキスト</p>
									<p class="p-menu__text-right">鴨鍋 / 前菜三種 / 糸撚鯛と季節野菜の天ぷら / 焼き魚 / 茶碗蒸し / 御飯 / デザート<br>
										※2日前までにご予約下さい。</p>
								</div>
							</div>
						</div>
						...
						<div class="p-rooms__panel" data-panel="medium">
							<div class="p-rooms__item">
								...
								<div class="p-rooms__detail">
									<h3 class="p-rooms__name">作州御膳</h3>
									<div class="p-menu__price-wrapper p-menu__price-wrapper--right">
										<p class="p-menu__price">4,400<span>円</span></p>
										<p class="p-menu__tax">（税込み）</p>
									</div>
									<p class="p-rooms__description">テキストがメタイタ、ダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキスト</p>
									<p class="p-menu__text-right">奈義和牛（なぎビーフ）60g / 海老と穴子の天ぷら / 御造り / 茶碗蒸し / 小鉢 / 御飯 / 漬物 / 吸い物 / フルーツ</p>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="p-meal__content" id="anc03">
				...
				<div class="p-menu__double">
					<div class="p-menu__double-item">
						...
						<div class="p-menu__double-detail">
							<h4 class="p-menu__double-title fz30">和食ランチ</h4>
					...
					<div class="p-menu__double-item">
						...
						<div class="p-menu__double-detail">
							<h4 class="p-menu__double-title fz30">洋食ランチ</h4>
							<p class="p-menu__double-tag">1日20食限定</p>
						</div>
						<div class="p-menu__price-wrapper p-menu__price-wrapper--right">
							<p class="p-menu__price">2,200<span>円</span></p>
		...
		<div class="l-inner">
			<div class="p-meal__content" id="anc07">
				...
				<div class="p-menu__invite" id="anc08">
					...
					<div class="p-menu__invite-box">
						<div class="p-menu__invite__row pt68">
