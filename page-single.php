        ...
        <div class="p-stay-mv__content">
          <div class="p-stay-mv__detail">
            <h2 class="c-main-title">
              ...
              <span class="c-main-title__ja">シングルルーム</span>
              <span class="c-main-title__en">Single Room</span>
            </h2>
          </div>
        </div>
      </div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <figure class="p-suite-swiper__img">
              <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/stay/single/img01.webp" alt="シングルルーム" width="1300" height="970">
            </figure>
          </div>
          <div class="swiper-slide">
            <figure class="p-suite-swiper__img">
              <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/stay/single/img02.webp" alt="シングルルーム" width="1300" height="970">
            </figure>
          </div>
          <div class="swiper-slide">
            <figure class="p-suite-swiper__img">
              <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/stay/single/img03.webp" alt="シングルルーム" width="1300" height="970">
            </figure>
          </div>
      ...
      <div class="l-inner">
        <div class="p-location__content">
          ...
          <div class="p-location__text-wrapper js-fadeUp">
            <p class="p-location__text">２タイプのお部屋を用意しております。<br>
            セミダブルのベットでゆとりある時間をお楽しみいただけます。</p>
          </div>
          ...
          <div class="p-rooms__qa mt66 js-fadeUp">
            <div class="p-service__left">
              ...
              <figure class="p-service__img mt50">
                <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/stay/room-single.webp" alt="宿泊サービス" width="400" height="600">
              </figure>
            </div>
        ...
        <div class="p-other__content">
          ...
          <div class="p-other__cards">
            <div class="p-other__grid">
              <a href="<?php echo esc_url(home_url('/suite-a')); ?>" class="p-other__card js-fadeUp">
              ...
              <a href="<?php echo esc_url(home_url('/suite-b')); ?>" class="p-other__card js-fadeUp">
                <figure class="p-other__card-img">
                  <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/common/other_1.jpg" alt="スイートルーム B-type" width="360" height="240">
                </figure>
                <div class="p-other__card-bg">
              ...
              <a href="<?php echo esc_url(home_url('/twin')); ?>" class="p-other__card js-fadeUp">
                <figure class="p-other__card-img">
              ...
              <a href="<?php echo esc_url(home_url('/double')); ?>" class="p-other__card js-fadeUp">
                <figure class="p-other__card-img">
              ...
              <a href="<?php echo esc_url(home_url('/japanese')); ?>" class="p-other__card js-fadeUp">
                <figure class="p-other__card-img">
