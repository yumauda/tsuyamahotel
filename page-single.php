<?php get_header(); ?>
  <main class="p-top">
    ...
    <section class="p-location p-location--suite">
      <div class="l-inner">
        <div class="p-location__content js-fadeIn">
    ...
    <section class="p-service">
      <div class="l-inner">
        <div class="p-service__content">
          <div class="p-rooms__qa mt66 js-fadeIn">
          ...
          <div class="p-service__reserve js-fadeIn">
            <div class="p-reserve">
        ...
        <div class="p-other__content">
          ...
          <div class="p-other__cards">
            <div class="p-other__grid">
              ...
              <a href="<?php echo esc_url(home_url('/suite-b')); ?>" class="p-other__card js-fadeIn">
                <figure class="p-other__card-img">
                  <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/common/other_1.jpg" alt="スイートルーム B-type" width="360" height="240">
                </figure>
                <div class="p-other__card-bg">
              ...
              <a href="<?php echo esc_url(home_url('/twin')); ?>" class="p-other__card js-fadeIn">
                <figure class="p-other__card-img">
              ...
              <a href="<?php echo esc_url(home_url('/double')); ?>" class="p-other__card js-fadeIn">
                <figure class="p-other__card-img">
              ...
              <a href="<?php echo esc_url(home_url('/japanese')); ?>" class="p-other__card js-fadeIn">
                <figure class="p-other__card-img">
