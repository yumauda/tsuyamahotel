        ...
        <div class="p-stay-mv__content">
          <div class="p-stay-mv__detail">
            <h2 class="c-main-title">
              ...
              <span class="c-main-title__ja">スイートルーム B-type</span>
              <span class="c-main-title__en">Suite Room B-type</span>
            </h2>
          </div>
        </div>
      </div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <figure class="p-suite-swiper__img">
              <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/stay/suite-b/img01.webp" alt="スイートルーム B-type" width="1300" height="970">
            </figure>
          </div>
          <div class="swiper-slide">
            <figure class="p-suite-swiper__img">
              <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/stay/suite-b/img02.webp" alt="スイートルーム B-type" width="1300" height="970">
            </figure>
          </div>
          <div class="swiper-slide">
            <figure class="p-suite-swiper__img">
              <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/stay/suite-b/img03.webp" alt="スイートルーム B-type" width="1300" height="970">
            </figure>
          </div>
      ...
      <div class="l-inner">
        <div class="p-location__content">
          <div class="p-location__title-wrapper js-fadeUp">
            <h3 class="p-location__title">明るく落ち着いた雰囲気のスイートルーム。</h3>
          </div>
          <div class="p-location__text-wrapper js-fadeUp">
            <p class="p-location__text">ゆとりあるリビングと独立したベッドルーム・和室も完備し、<br>快適な滞在をお約束します。</p>
          </div>
          ...
          <div class="p-rooms__qa mt66 js-fadeUp">
            <div class="p-service__left">
              ...
              <figure class="p-service__img mt50">
                <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/stay/room-suite-b.webp" alt="宿泊サービス" width="400" height="600">
              </figure>
            </div>
        ...
        <div class="p-other__content">
          ...
          <div class="p-other__cards">
            <div class="p-other__grid">
              ...
              <a href="<a href="<?php echo esc_url(home_url('/double')); ?>" class="p-other__card js-fadeUp">" class="p-other__card js-fadeUp">
                <figure class="p-other__card-img">
