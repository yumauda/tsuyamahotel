        ...
        <div class="p-stay-mv__content">
          <div class="p-stay-mv__detail">
            <h2 class="c-main-title">
              ...
              <span class="c-main-title__ja">ツインルーム</span>
              <span class="c-main-title__en">Twin Room</span>
            </h2>
          </div>
        </div>
      </div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <figure class="p-suite-swiper__img">
              <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/stay/twin/img01.webp" alt="ツインルーム" width="1300" height="970">
            </figure>
          </div>
          <div class="swiper-slide">
            <figure class="p-suite-swiper__img">
              <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/stay/twin/img02.webp" alt="ツインルーム" width="1300" height="970">
            </figure>
          </div>
          <div class="swiper-slide">
            <figure class="p-suite-swiper__img">
              <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/stay/twin/img03.webp" alt="ツインルーム" width="1300" height="970">
            </figure>
          </div>
      ...
      <div class="l-inner">
        <div class="p-location__content">
          <div class="p-location__title-wrapper js-fadeUp">
            <h3 class="p-location__title">吉井川を眺める見晴らしの良いツインルームと<br>静寂を求める山側のツインルーム。</h3>
          </div>
          <div class="p-location__text-wrapper js-fadeUp">
            <p class="p-location__text">くつろぎのひと時をお過ごしいただけます。<br>３名様利用の場合はエキストラベットをお入れします。</p>
          </div>
          ...
          <div class="p-rooms__qa mt66 js-fadeUp">
            <div class="p-service__left">
              ...
              <figure class="p-service__img mt50">
                <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/stay/room-twin.webp" alt="宿泊サービス" width="400" height="600">
              </figure>
            </div>
